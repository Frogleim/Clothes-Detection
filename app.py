...
if __name__ == '__main__':
    img = Read_Img_2_Tensor('./images/ronaldo.jpg')
    model = Load_Model()
    ...
    # cv2.imwrite("./images/test2_clothes_detected.jpg", cv2.cvtColor(img_with_boxes, cv2.COLOR_RGB2BGR)*255)
    # cv2.imshow("Clothes detection", cv2.cvtColor(crop_img, cv2.COLOR_RGB2BGR))
